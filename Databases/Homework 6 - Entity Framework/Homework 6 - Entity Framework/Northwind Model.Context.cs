...
namespace Homework_6___Entity_Framework
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<decimal>> TotalIncomesForGivenSupplier(string supplierName, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("TotalIncomesForGivenSupplier", supplierNameParameter, startDateParameter, endDateParameter);
        }
    }
}
