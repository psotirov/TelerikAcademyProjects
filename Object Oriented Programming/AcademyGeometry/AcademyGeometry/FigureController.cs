    ...
    public class FigureController
    {
        ...
        protected virtual void ExecuteFigureInstanceCommand(string[] splitCommand)
        {
            switch (splitCommand[0])
            {
                ...
                case "area":
                    {
                        if ((this.currentFigure as IAreaMeasurable) != null) // checks if it can get the area
                        {
                ...
                case "volume":
                    // adds "volume" command
                    {
                        if ((this.currentFigure as IVolumeMeasurable) != null) // checks if it can get the volume
                        {
                ...
                case "normal":
                    {
                        if ((this.currentFigure as IFlat) != null) // checks if it can get the normal vector
                        {
